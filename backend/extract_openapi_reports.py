...
Extrai todos os endpoints de relatórios:
- /api/v1/reports/* (módulo reports principal)
- /api/v1/reports/intelligent/* (intelligent reports)
...
def extract_reports_openapi():
    ...
    # Gera OpenAPI completo
    openapi_schema = get_openapi(
        title="Conecta PRO - Reports API",
        version="2.0.0",
        description="API completa do módulo de Relatórios (Reports, Intelligent Reports, AI Reports, Operational Reports)",
        routes=app.routes,
    )
