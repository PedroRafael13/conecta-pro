...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('tender_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('bidding_tenders.id'), nullable=False, index=True),
    ...
    op.create_table(
        ...
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('proposal_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('bidding_proposals.id'), nullable=False, index=True),
    ...
    op.create_table(
        ...
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('tender_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('bidding_tenders.id'), nullable=True, index=True),
    ...
    op.create_table(
        ...
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('contrato_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('bidding_public_contracts.id'), nullable=False, index=True),
