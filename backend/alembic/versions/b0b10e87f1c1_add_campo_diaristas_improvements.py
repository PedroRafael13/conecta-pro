...
def upgrade() -> None:
    ...
    op.create_table(
        'checklist_respostas',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('checklist_preenchido_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('checklist_preenchido.id'), nullable=False),
    ...
    op.create_table(
        'retencoes_fiscais',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('documento_fiscal_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('documentos_fiscais.id'), nullable=False),
