...
def upgrade() -> None:
    ...
    op.create_table('seller_commission_rules',
        sa.Column('id', sa.UUID(as_uuid=False), nullable=False),
    ...
    op.create_index(op.f('ix_seller_commission_rules_seller_id'), 'seller_commission_rules', ['seller_id'], unique=False)
    ...
    op.create_index(op.f('ix_commission_payments_commission_id'), 'commission_payments', ['commission_id'], unique=False)

    # Tabela de resumo mensal de comissões
    op.create_table('commission_summaries',
        sa.Column('id', sa.UUID(as_uuid=False), nullable=False),
        sa.Column('seller_id', sa.UUID(as_uuid=False), nullable=False),
    ...
    op.create_index('ix_commission_summaries_period', 'commission_summaries', ['seller_id', 'year', 'month'], unique=True)
