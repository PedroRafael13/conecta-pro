...
down_revision: Union[str, None] = 'sprint31_document_kits'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'tipos_servico',
            postgresql.ARRAY(sa.Enum(
                'LIMPEZA', 'FAXINA', 'PASSADEIRA', 'COZINHEIRA',
                'BABA', 'CUIDADORA', 'JARDINEIRO', 'MANUTENCAO', 'OUTROS',
                name='diarist_type_array', create_type=False
            )),
            nullable=True
        ),
        ...
        sa.Column(
            ...
            postgresql.ARRAY(sa.Enum(
                'MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY',
                'FRIDAY', 'SATURDAY', 'SUNDAY',
                name='weekday_array', create_type=False
            )),
            nullable=True
        ),
        ...
        sa.Column(
            ...
            postgresql.ENUM(
                'ATIVO', 'INATIVO', 'SUSPENSO', 'PENDENTE', 'BLOQUEADO',
                name='diarist_status', create_type=False
            ),
            nullable=False,
            default='PENDENTE'
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.ENUM(
                'AVULSO', 'SEMANAL', 'QUINZENAL', 'MENSAL',
                name='recurrence_type', create_type=False
            ),
            nullable=False,
            default='AVULSO'
        ),
        sa.Column(
            ...
            postgresql.ARRAY(sa.Enum(
                'MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY',
                'FRIDAY', 'SATURDAY', 'SUNDAY',
                name='weekday_array2', create_type=False
            )),
            nullable=True
        ),
