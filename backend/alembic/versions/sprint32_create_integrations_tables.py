...
down_revision: Union[str, None] = 'sprint31_services'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'category',
            sa.Enum(
                'authentication', 'clients', 'services', 'financial',
                'documents', 'reports', 'analytics', 'webhooks',
                'sync', 'admin',
        ...
        sa.Column(
            'status',
            sa.Enum(
                'active', 'deprecated', 'beta', 'maintenance', 'disabled',
                name='endpointstatus'
            ),
            nullable=False,
            default='active'
    ...
    op.create_table(
        ...
        sa.Column(
            'key_type',
            sa.Enum(
                'production', 'sandbox', 'development', 'testing',
                name='apikeytype'
            ),
            nullable=False,
            default='production'
    ...
    op.create_table(
        ...
        sa.Column(
            'payload_format',
            sa.Enum('json', 'xml', 'form', name='webhookformat'),
            nullable=False,
            default='json'
        ),
        ...
        sa.Column(
            'auth_type',
            sa.Enum(
                'none', 'basic', 'bearer', 'api_key', 'hmac', 'oauth2',
    ...
    op.create_table(
        ...
        sa.Column(
            'log_type',
            sa.Enum(
                'api_call', 'webhook_delivery', 'sync_operation',
                'authentication', 'rate_limit', 'error', 'system',
                name='logtype'
            ),
            nullable=False,
            default='api_call'
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                'rate_limited', 'unauthorized', 'validation_error',
                name='logstatus'
            ),
            nullable=False,
            default='success'
    ...
    op.create_table(
        ...
        sa.Column(
            'external_system',
            sa.Enum(
                'sap', 'totvs', 'omie', 'bling', 'tiny',
                'netsuite', 'salesforce', 'hubspot', 'pipedrive', 'custom',
                name='externalsystem'
            ),
            nullable=False,
            default='custom'
        ...
        sa.Column(
            'entity_type',
            sa.Enum(
                'client', 'service', 'service_order', 'invoice', 'payment',
                'document', 'product', 'inventory', 'user', 'lead',
                'proposal', 'contract',
                name='syncentitytype'
            ),
            nullable=False
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                'retrying', 'cancelled', 'skipped', 'partial',
                name='syncstatus'
            ),
            nullable=False,
            default='pending'
