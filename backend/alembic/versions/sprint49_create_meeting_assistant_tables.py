...
def upgrade() -> None:
    ...
    participant_status_enum = postgresql.ENUM(
        "PENDING", "ACCEPTED", "DECLINED", "TENTATIVE", "NO_RESPONSE", name="participantstatus_enum", create_type=False
    )
    ...
    task_priority_enum = postgresql.ENUM(
        "CRITICAL", "HIGH", "MEDIUM", "LOW", "NONE", name="taskpriority_enum", create_type=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            postgresql.ENUM("CRITICAL", "HIGH", "MEDIUM", "LOW", "NONE", name="taskpriority_enum", create_type=False),
            nullable=False,
