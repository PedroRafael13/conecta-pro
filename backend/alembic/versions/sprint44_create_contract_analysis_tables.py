...
def upgrade() -> None:
    ...
    # Indices
    op.create_index("ix_analyses_contract_status", "contract_analyses", ["contract_id", "status"])
    op.create_index("ix_analyses_dates", "contract_analyses", ["start_date", "end_date"])
    op.create_index("ix_analyses_risk", "contract_analyses", ["risk_level", "risk_score"])
    ...
    op.create_table(
        ...
        sa.Column(
            "importance",
            ENUM("low", "medium", "high", "critical", name="clause_importance", create_type=False),
    ...
    # Indices
    op.create_index("ix_clauses_analysis_type", "contract_extracted_clauses", ["analysis_id", "clause_type"])
    op.create_index("ix_clauses_risky", "contract_extracted_clauses", ["is_risky", "risk_score"])
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            ENUM("low", "medium", "high", "urgent", "critical", name="alert_priority", create_type=False),
            server_default="medium",
            nullable=False,
            index=True,
        ),
    ...
    # Indices
    op.create_index("ix_alerts_contract_status", "contract_alerts", ["contract_id", "status"])
    op.create_index("ix_alerts_priority_due", "contract_alerts", ["priority", "due_date"])
    op.create_index("ix_alerts_trigger", "contract_alerts", ["trigger_date", "is_active"])
