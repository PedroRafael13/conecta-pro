...
down_revision: Union[str, None] = 'sprint17_rep_integration'
...
def upgrade() -> None:
    ...
    op.create_index('ix_mobile_devices_employee_active', 'mobile_devices',
                    ['employee_id', 'is_active'])
    op.create_index('ix_mobile_devices_condominio_status', 'mobile_devices',
    ...
    op.create_index('ix_geofence_zones_location', 'geofence_zones',
                    ['center_latitude', 'center_longitude'])
    op.create_index('ix_geofence_zones_condominio_active', 'geofence_zones',
                    ['condominio_id', 'is_active', 'status'])
    ...
    op.create_index('ix_mobile_checkins_employee_date', 'mobile_checkins',
                    ['employee_id', 'checkin_date'])
    op.create_index('ix_mobile_checkins_status', 'mobile_checkins',
                    ['status', 'has_anomaly'])
    op.create_index('ix_mobile_checkins_condominio_date', 'mobile_checkins',
                    ['condominio_id', 'checkin_date'])
    op.create_index('ix_mobile_checkins_offline', 'mobile_checkins',
                    ['offline_id'], unique=True, postgresql_where=sa.text("offline_id IS NOT NULL"))
    ...
    op.create_index('ix_offline_queue_status_retry', 'offline_queue',
                    ['status', 'next_retry_at'])
    op.create_index('ix_offline_queue_device_pending', 'offline_queue',
                    ['device_id', 'status'])
    op.create_index('ix_offline_queue_expiration', 'offline_queue',
