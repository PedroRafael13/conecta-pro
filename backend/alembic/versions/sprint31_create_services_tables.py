...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'category',
            sa.Enum(
                'manutencao_predial', 'limpeza', 'seguranca', 'jardinagem',
                'piscina', 'elevadores', 'portaria', 'administracao',
                'consultoria', 'tecnologia', 'eventos', 'outros',
        ...
        sa.Column(
            'service_type',
            sa.Enum(
                'pontual', 'recorrente', 'emergencia', 'preventivo',
                'corretivo', 'consultivo', 'projeto',
                name='servicetype'
            ),
            nullable=False,
        ...
        sa.Column(
            'status',
            sa.Enum(
                'ativo', 'inativo', 'suspenso', 'descontinuado',
                name='servicestatus'
            ),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            'status',
            sa.Enum(
                'rascunho', 'pendente', 'aprovada', 'agendada', 'em_andamento',
                'pausada', 'concluida', 'cancelada', 'rejeitada',
                name='orderstatus'
            ),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            'status',
            sa.Enum(
                'agendada', 'em_deslocamento', 'no_local', 'em_execucao',
                'pausada', 'aguardando_material', 'aguardando_aprovacao',
                'concluida', 'cancelada',
    ...
    op.create_table(
        ...
        sa.Column(
            'report_type',
            sa.Enum(
                'execucao', 'inspecao', 'auditoria', 'tecnico',
                'orcamento', 'laudo', 'vistoria', 'preventivo',
                'corretivo', 'final',
                name='reporttype'
            ),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            'metric_type',
            sa.Enum(
                'tempo_resposta', 'tempo_resolucao', 'disponibilidade',
                'uptime', 'qualidade', 'satisfacao', 'primeiro_contato',
                'reincidencia',
                name='slametrictype'
            ),
            nullable=False,
