...
def upgrade():
    ...
    try:
        ...
        logger.warning("Tabela gov_documentos_fiscais pode nao existir ainda")  # Tabela pode nao existir ainda
...
def downgrade():
    ...
    try:
        ...
        logger.warning("Erro ao remover colunas de gov_documentos_fiscais")
