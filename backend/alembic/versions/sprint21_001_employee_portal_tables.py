...
down_revision: str | None = "sprint20_payroll"
...
def upgrade() -> None:
    ...
    op.create_unique_constraint(
        "uq_hr_vacation_requests_code", "hr_vacation_requests", ["condominio_id", "request_code"]
    )
    op.create_foreign_key(
        "fk_vacation_request_period", "hr_vacation_requests", "hr_vacation_periods", ["period_id"], ["id"]
    )
