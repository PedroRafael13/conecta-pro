...
def upgrade():
    ...
    op.add_column(
        "receivable_accounts", sa.Column("boleto_generated", sa.Boolean(), nullable=True, server_default="false")
    )
    op.add_column(
        "receivable_accounts", sa.Column("pix_generated", sa.Boolean(), nullable=True, server_default="false")
    )
    ...
    op.add_column(
        "cashflow_entries", sa.Column("is_discretionary", sa.Boolean(), nullable=True, server_default="false")
    )
    ...
    op.add_column(
        "bank_accounts", sa.Column("integration_enabled", sa.Boolean(), nullable=True, server_default="false")
    )
    ...
    op.add_column(
        "bank_accounts", sa.Column("allow_negative_balance", sa.Boolean(), nullable=True, server_default="false")
    )
    ...
    op.add_column(
        "billing_rules", sa.Column("notifications_enabled", sa.Boolean(), nullable=True, server_default="true")
    )
