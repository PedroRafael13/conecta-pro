...
async def test_portal_selfservice_roi():
    ...
    # ROI total
    roi_total = (
        economia_atendimento_humano
        + economia_call_center
        + economia_pagamentos
        + economia_documentos
        + economia_agendamentos
        + economia_tempo_funcionarios
        + economia_retencao
        + economia_treinamento
        + negocios_fora_horario
        + valor_insights_portal
        + economia_erros_humanos
        + valor_escalabilidade
    )
