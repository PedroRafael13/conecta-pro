...
imports = [
    ...
    ("modules.crm.controllers", """from modules.crm.controllers import (
        commission_router, contract_router, dashboard_router,
        lead_router, opportunity_router, proposal_router)"""),
    ("modules.operations.controllers", """from modules.operacional.controllers import (
        allocation_router, post_router, scale_router, shift_router,
        substitution_router, time_bank_router)"""),
    ("modules.financial.controllers", """from modules.financial.controllers import (
    ...
    ("modules.automation.workflow.controllers", "from modules.automation.workflow.controllers import router as workflow_router"),
