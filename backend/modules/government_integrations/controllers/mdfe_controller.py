...
async def get_status(
    service: MDFeService = Depends(get_service)
) -> StandardResponse:
...
async def criar_mdfe(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"MDF-e {resultado['numero']} criado com sucesso",
            data=resultado
        )
...
async def gerar_xml(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"XML gerado para MDF-e {resultado['numero']}",
            data=resultado
        )
...
async def encerrar_mdfe(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"Evento de encerramento gerado para MDF-e",
            data=resultado
        )
...
async def incluir_condutor(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"Evento de inclusao de condutor gerado",
            data=resultado
        )
...
async def consultar_status_servico(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"Status do servico: {resultado['status']}",
            data=resultado
        )
...
async def consultar_nao_encerrados(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"{resultado['quantidade']} MDF-e nao encerrados",
            data=resultado
        )
...
async def listar_modais(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message="Modais de transporte listados",
            data=resultado
        )
...
async def listar_tipos_emitente(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message="Tipos de emitente listados",
            data=resultado
        )
...
async def listar_tipos_carroceria(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message="Tipos de carroceria listados",
            data=resultado
        )
...
@router.get(
    ...
    response_model=StandardResponse,
    summary="Lista MDF-e",
    description="Lista todos os MDF-e em memoria"
)
async def listar_mdfes(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"{resultado['quantidade']} MDF-e encontrados",
            data=resultado
        )
...
@router.get(
    ...
    description="Busca um MDF-e pelo ID"
)
async def buscar_mdfe(
    ...
    try:
        ...
        if not resultado:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail=f"MDF-e nao encontrado: {mdfe_id}"
            )

        return StandardResponse(
            success=True,
            message=f"MDF-e {resultado['numero']} encontrado",
            data=resultado
        )
...
@router.delete(
    ...
    description="Limpa todos os MDF-e em memoria"
)
