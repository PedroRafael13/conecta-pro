...
async def get_status(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message="Status SPED Fiscal obtido",
            data=status_data
        )
...
async def listar_participantes(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"{len(participantes['participantes'])} participantes",
            data=participantes
        )
...
async def listar_produtos(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"{len(produtos['produtos'])} produtos",
            data=produtos
        )
...
async def listar_documentos(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"{len(documentos['documentos'])} documentos",
            data=documentos
        )
...
async def adicionar_participante(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"Participante {resultado['codigo']} adicionado",
            data=resultado
        )
...
async def adicionar_produto(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"Produto {resultado['codigo']} adicionado",
            data=resultado
        )
...
async def adicionar_documento(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"Documento {resultado['numero']} adicionado",
            data=resultado
        )
...
async def adicionar_inventario(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            message=f"Item {resultado['codigo_item']} adicionado",
            data=resultado
        )
...
async def calcular_apuracao(
    request: CalcularApuracaoRequest,
    service: SPEDFiscalService = Depends(get_service)
) -> StandardResponse:
