...
async def listar_tipos_ecd(service: SPEDContabilService = Depends(get_service)) -> StandardResponse:
    ...
    try:
        ...
        return StandardResponse(success=True, message="Tipos listados", data=tipos)
...
async def listar_contas(service: SPEDContabilService = Depends(get_service)) -> StandardResponse:
    ...
    try:
        ...
        return StandardResponse(success=True, message=f"{len(contas['contas'])} contas", data=contas)
...
async def listar_lancamentos(service: SPEDContabilService = Depends(get_service)) -> StandardResponse:
    ...
    try:
        ...
        return StandardResponse(
            success=True, message=f"{len(lancamentos['lancamentos'])} lançamentos", data=lancamentos
        )
...
async def adicionar_conta(
    ...
    try:
        ...
        return StandardResponse(success=True, message=f"Conta {resultado['codigo']} adicionada", data=resultado)
...
async def adicionar_lancamento(
    ...
    try:
        ...
        return StandardResponse(success=True, message=f"Lançamento {resultado['numero']} adicionado", data=resultado)
...
async def definir_balanco(
    ...
    try:
        ...
        return StandardResponse(
            success=True, message=f"Balanço definido: Ativo R$ {resultado['total_ativo']}", data=resultado
        )
...
async def definir_dre(
    ...
    try:
        ...
        return StandardResponse(
            success=True, message=f"DRE definida: Lucro R$ {resultado['lucro_liquido']}", data=resultado
        )
...
async def calcular_saldos(
    ...
    try:
        ...
        return StandardResponse(
            success=True, message=f"Saldos calculados: {resultado['total_contas']} contas", data=resultado
        )
