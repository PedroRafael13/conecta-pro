...
async def run_command_center(session: AsyncSession) -> dict:
    ...
    if critical_alerts:
        insights.append({
            ...
            "description": (
                "Existem contas com mais de 60 dias de atraso. "
                "Ação imediata é necessária para minimizar perdas."
            ),
            "priority": 5,
        })
    ...
    if margin > 20:
        insights.append({
            ...
            "description": (
                "Operação com boa rentabilidade. "
                "Mantenha o controle de custos para sustentar o resultado."
            ),
            "priority": 1,
        })
        ...
        insights.append({
            ...
            "description": (
                "Receitas e despesas estão muito próximas. "
                "Revise contratos de baixa margem."
            ),
            "priority": 4,
        })
