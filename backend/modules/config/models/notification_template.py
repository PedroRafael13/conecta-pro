...
class NotificationTemplate(Base):
    """Model de Template de Notificação."""
    ...
    def __repr__(self) -> str:
        return f"<NotificationTemplate {self.codigo}: {self.channel.value}>"
    ...
    def render(self, variables: dict) -> dict:
        ...
        if self.channel == NotificationChannel.EMAIL:
            ...
            result = {
                "body": self._replace_variables(self.sms_body, variables)
            }
        ...
        elif self.channel == NotificationChannel.IN_APP:
            result = {
    ...
    def clone(self, new_codigo: str = None) -> "NotificationTemplate":
        """Clona o template."""
