...
# Inclui router de notificações
diarists_router.include_router(notificacao_router, prefix="/notificacoes", tags=["Diaristas - Notificações"])

# Inclui router fiscal
diarists_router.include_router(fiscal_router, prefix="/fiscal", tags=["Diaristas - Fiscal"])
