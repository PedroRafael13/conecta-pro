...
class PredictiveAnalyzer:
    ...
    async def predict_absences(
        ...
        for emp in employees:
            ...
            predictions.extend([p for p in emp_predictions if p.probability >= confidence_threshold])
    ...
    async def _load_overtime_history(
        ...
        return [{"date": date.today() - timedelta(days=i), "hours": random.uniform(2, 8)} for i in range(30)]  # noqa: S311
