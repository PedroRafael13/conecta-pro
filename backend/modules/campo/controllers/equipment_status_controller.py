...
from modules.campo.repositories.equipment_status_repository import (
    EquipmentStatusRepository,
)
from modules.campo.schemas.equipment_status import (
...
async def create_equipment_status(
    ...
    if existing:
        ...
        equipment = await repo.update_by_external_id(data.external_id, update_data)
