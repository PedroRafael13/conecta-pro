...
class BartoloNLUService:
    ...
    def _build_entity_patterns(self) -> dict[EntityType, list[str]]:
        ...
        return {
            ...
            EntityType.NUMBER: [r"\b\d+([.,]\d+)?\b", r"\b(um|dois|três|quatro|cinco|dez|cem|mil|milhão)\b"],
    ...
    async def _generate_response(self, nlu_result: NLUResult) -> str:
        ...
        if intent.type == IntentType.GREETING:
            ...
            return (
                "Entendi sua mensagem, mas preciso de mais detalhes para ajudar melhor. Pode reformular sua pergunta?"
            )
...
Fale naturalmente comigo - entendo português! 😊"""
    ...
    async def _handle_question(self, nlu_result: NLUResult) -> str:
        ...
        [e for e in nlu_result.entities if e.type == EntityType.METRIC]
