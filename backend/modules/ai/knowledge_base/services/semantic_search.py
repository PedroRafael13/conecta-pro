...
class SemanticSearchEngine:
    ...
    def __init__(self):
        ...
        self.stopwords = {
            ...
            "com", "na", "no", "que", "se", "por", "mais", "como", "mas",
            "foi", "ao", "ele", "das", "tem", "seu", "sua", "ou", "ser",
            "quando", "muito", "ha", "nos", "ja", "esta", "eu", "tambem",
            "so", "pelo", "pela", "ate", "isso", "ela", "entre", "era",
            "depois", "sem", "mesmo", "aos", "ter", "seus", "quem", "nas",
            "me", "esse", "eles", "estao", "voce", "tinha", "foram", "essa",
            "num", "nem", "suas", "meu", "as", "minha", "numa", "pelos",
            "elas", "qual", "nos", "lhe", "deles", "essas", "esses",
    ...
    def search(
        ...
        for result in results:
            ...
            result["matched_keywords"] = self._find_matched_keywords(
