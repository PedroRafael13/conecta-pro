...
def registrar_tasks_sst(celery_app):
    """Registra tasks SST no Celery app."""

    @celery_app.task(name="sst.verificar_afastamentos_vencidos")
    ...
    @celery_app.task(name="sst.verificar_inss_pendente")
    ...
    return {
        "verificar_afastamentos_vencidos": verificar_afastamentos_vencidos,
        "verificar_inss_pendente": verificar_inss_pendente,
    }
