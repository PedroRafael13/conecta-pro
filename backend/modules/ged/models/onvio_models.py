"""GEDEON Fase 3 — Onvio Sync Models"""
...
class OnvioDocument(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    onvio_id = Column(String(64), unique=True, nullable=False)  # ID no Onvio
    onvio_folder_id = Column(String(64), nullable=False)
    nome_arquivo = Column(String(255), nullable=False)
    categoria = Column(String(50), nullable=False)
    mes_ref = Column(String(7))  # "03.2026"
    caminho_local = Column(String(512))  # /opt/conecta-pro/storage/onvio/...
