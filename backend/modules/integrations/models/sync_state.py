...
from sqlalchemy import (
    ...
    Integer, Index, ForeignKey, UniqueConstraint
)
...
class SyncState(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            name="uq_sync_state_tenant_account_entity"
        ),
    ...
    def has_valid_cursor(self) -> bool:
        ...
        return bool(
            ...
            or self.last_page
            or self.last_offset
            or self.last_sync_timestamp
            or self.last_synced_id
        )
    ...
    @property
    def days_since_full_sync(self) -> Optional[int]:
