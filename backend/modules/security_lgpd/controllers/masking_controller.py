...
async def mask_data(request: MaskDataRequest, current_user: dict = Depends(get_current_user)) -> StandardResponse:
    """
...
async def list_masking_formats(current_user: dict = Depends(get_current_user)) -> StandardResponse:
    """
