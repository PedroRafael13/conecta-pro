...
class Atlas:
    """
    Agente de Aprendizado — registra e aprende com cada ciclo
    de montagem de kit. Persiste em gedeon_kit_history e
    gedeon_client_patterns via SyncSessionLocal (psycopg2,
    sem subprocess).
    """
    ...
    def obter_contexto_historico(self, client_id: str, competencia: str) -> dict[str, Any]:
        """
    ...
    def detectar_anomalia(self, client_id: str, docs_atual: int, score_atual: int) -> str | None:
        """
