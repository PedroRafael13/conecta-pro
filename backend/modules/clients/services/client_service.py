...
class ClientService:
    ...
    def get_client_full(self, client_id: UUID) -> Optional[Client]:
    ...
    def get_condominium_full(self, condominium_id: UUID) -> Optional[Condominium]:
    ...
    def get_contract(self, contract_id: UUID) -> Optional[ClientContract]:
    ...
    def create_integration(
        ...
        logger.info(
            "Integração criada: %s - %s",
            integration.id, integration.integration_type
        )
        return integration

    def get_integration(self, settings_id: UUID) -> Optional[IntegrationSettings]:
