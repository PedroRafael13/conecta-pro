-- Tabelas GED com VARCHAR para enums (compativel com native_enum=False)
...
CREATE TABLE ged_document_shares (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    document_id UUID NOT NULL REFERENCES ged_documents(id) ON DELETE CASCADE,
    share_type VARCHAR(20) NOT NULL DEFAULT 'usuario',
    shared_with_id UUID,
    shared_with_email VARCHAR(255),
    shared_with_name VARCHAR(255),
    permissions JSONB DEFAULT '["visualizar"]'::jsonb,
...
CREATE TABLE ged_document_signatures (
    ...
    signer_role VARCHAR(30) DEFAULT 'parte',
...
-- Criar pastas raiz do sistema
INSERT INTO ged_folders (code, name, description, folder_type, status, owner_id, created_by, is_public)
VALUES
('ROOT-001', 'Documentos', 'Pasta raiz do sistema', 'sistema', 'ativa', '00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000', true),
('ROOT-002', 'Clientes', 'Documentos de clientes', 'cliente', 'ativa', '00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000', false),
('ROOT-003', 'Contratos', 'Contratos e documentos legais', 'contrato', 'ativa', '00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000', false),
('ROOT-004', 'RH', 'Documentos de colaboradores', 'funcionario', 'ativa', '00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000', false);
