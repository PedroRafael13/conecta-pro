...
async def test_facilities_roi():
    ...
    maintenance_savings = avg_maintenance_cost * num_equipamentos * maintenance_cycles_year * (maintenance_efficiency / 100)
    ...
    # ROI total
    roi_total = (economia_anual + downtime_savings + maintenance_savings + 
                parts_optimization + catastrophic_prevention + energy_optimization)
