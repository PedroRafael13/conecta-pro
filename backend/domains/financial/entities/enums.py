...
class AccountType(str, Enum):
    ...
    def is_debit_nature(self) -> bool:
        ...
        return self in [
            self.ASSET_CURRENT, self.ASSET_NON_CURRENT,
            self.ASSET_FIXED, self.ASSET_INTANGIBLE,
            self.EXPENSE_OPERATING, self.EXPENSE_ADMINISTRATIVE,
            self.EXPENSE_FINANCIAL, self.EXPENSE_TAX, self.EXPENSE_OTHER,
            self.COST_GOODS, self.COST_SERVICES
        ]
    ...
    def is_balance_sheet_account(self) -> bool:
        ...
        return self in [
            self.ASSET_CURRENT, self.ASSET_NON_CURRENT,
            self.ASSET_FIXED, self.ASSET_INTANGIBLE,
            self.LIABILITY_CURRENT, self.LIABILITY_NON_CURRENT,
            self.EQUITY_CAPITAL, self.EQUITY_RESERVES, self.EQUITY_RETAINED
        ]
...
class JournalEntryType(str, Enum):
    ...
    def requires_approval(self) -> bool:
        ...
        return self in [
            self.ADJUSTING, self.CLOSING, self.REVERSAL, self.RECLASSIFICATION
        ]
