...
class TestVerificadorDisponibilidade:
    ...
    def test_gerar_relatorio(self):
        ...
        resultados = [
            ResultadoVerificacao(uf="SP", tipo_documento="nfe", endpoint="", disponivel=True, tempo_resposta_ms=100),
            ResultadoVerificacao(uf="RJ", tipo_documento="nfe", endpoint="", disponivel=True, tempo_resposta_ms=200),
            ResultadoVerificacao(
                uf="MG", tipo_documento="nfe", endpoint="", disponivel=False, tempo_resposta_ms=0, erro="Timeout"
            ),
        ]
