...
class TestReportTemplateService:
    ...
    def test_create_template(self, report_service, mock_db):
        ...
        with patch.object(report_service.repository, "create_template") as mock_create:
    ...
    def test_get_template(self, report_service, sample_template):
        ...
        with patch.object(report_service.repository, "get_template_by_id") as mock_get:
    ...
    def test_list_templates(self, report_service, sample_template):
        ...
        with patch.object(report_service.repository, "list_templates") as mock_list:
    ...
    def test_delete_template(self, report_service, sample_template):
        ...
        with (
            patch.object(report_service.repository, "get_template_by_id") as mock_get,
            patch.object(report_service.repository, "delete_template") as mock_delete,
        ):
            mock_get.return_value = sample_template
...
class TestReportScheduleService:
    ...
    def test_create_schedule(self, report_service, sample_template):
        ...
        with (
            patch.object(report_service.repository, "get_template_by_id") as mock_get_template,
            patch.object(report_service.repository, "create_schedule") as mock_create,
        ):
    ...
    def test_get_schedule(self, report_service, sample_schedule):
        ...
        with patch.object(report_service.repository, "get_schedule_by_id") as mock_get:
    ...
    def test_list_schedules(self, report_service, sample_schedule):
        ...
        with patch.object(report_service.repository, "list_schedules") as mock_list:
...
class TestReportExportService:
    ...
    def test_request_export(self, report_service, sample_template):
        ...
        with (
            patch.object(report_service.repository, "get_template_by_id") as mock_get_template,
            patch.object(report_service.repository, "create_export") as mock_create,
        ):
            mock_get_template.return_value = sample_template
            mock_create.return_value = MagicMock(
                id=uuid.uuid4(),
    ...
    def test_get_export(self, report_service, sample_export):
        ...
        with patch.object(report_service.repository, "get_export_by_id") as mock_get:
    ...
    def test_list_exports(self, report_service, sample_export):
        ...
        with patch.object(report_service.repository, "list_exports") as mock_list:
...
class TestExecutiveKPIService:
    ...
    def test_create_kpi(self, report_service):
        ...
        with patch.object(report_service.repository, "create_kpi") as mock_create:
            mock_create.return_value = MagicMock(
                id=uuid.uuid4(),
                codigo="KPI001",
            )
    ...
    def test_get_kpi(self, report_service, sample_kpi):
        """Testa busca de KPI."""
        with patch.object(report_service.repository, "get_kpi_by_id") as mock_get:
    ...
    def test_list_kpis(self, report_service, sample_kpi):
        ...
        with patch.object(report_service.repository, "list_kpis") as mock_list:
    ...
    def test_get_kpi_dashboard(self, report_service, sample_kpi):
        ...
        with (
            patch.object(report_service.repository, "get_dashboard_kpis") as mock_dash,
            patch.object(report_service.repository, "get_kpis_needing_attention") as mock_attention,
        ):
...
class TestBenchmarkService:
    ...
    def test_create_benchmark(self, report_service):
        ...
        with patch.object(report_service.repository, "create_benchmark") as mock_create:
            mock_create.return_value = MagicMock(
                id=uuid.uuid4(),
                codigo="BMK001",
            )
    ...
    def test_get_benchmark(self, report_service, sample_benchmark):
        ...
        with patch.object(report_service.repository, "get_benchmark_by_id") as mock_get:
    ...
    def test_list_benchmarks(self, report_service, sample_benchmark):
        ...
        with patch.object(report_service.repository, "list_benchmarks") as mock_list:
            mock_list.return_value = ([sample_benchmark], 1)
            result, total = report_service.list_benchmarks()
            assert len(result) == 1
            assert total == 1

    def test_update_benchmark_company_value(self, report_service, sample_benchmark):
...
class TestDashboardService:
    ...
    def test_get_reports_dashboard(self, report_service):
        ...
        with (
            patch.object(report_service.repository, "get_reports_dashboard_stats") as mock_stats,
            patch.object(report_service.repository, "get_top_templates") as mock_top,
            patch.object(report_service.repository, "get_due_schedules") as mock_due,
            patch.object(report_service.repository, "get_pending_exports") as mock_pending,
        ):
    ...
    def test_get_executive_dashboard(self, report_service, sample_kpi, sample_benchmark):
        ...
        with (
            patch.object(report_service.repository, "get_dashboard_kpis") as mock_kpis,
            patch.object(report_service.repository, "get_dashboard_benchmarks") as mock_benchmarks,
            patch.object(report_service.repository, "get_kpis_needing_attention") as mock_attention,
            patch.object(report_service.repository, "get_benchmarks_below_target") as mock_below,
        ):
