...
class TestReceitaFederalService:
    ...
    def test_consultar_cpf_invalido_levanta_erro(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            ReceitaFederalApiService.consultar_cpf(
                cpf="12345678901",
                data_nascimento=date(1990, 1, 15)
            )
    ...
    def test_consultar_cpf_retorna_campos_esperados(self):
        ...
        with patch(
            ...
            resultado = ReceitaFederalApiService.consultar_cpf(
                cpf="34559848245",
                data_nascimento=date(1975, 3, 25)
            )
    ...
    def test_consultar_cnpj_valido(self):
        ...
        with patch(
            ...
            resultado = ReceitaFederalApiService.consultar_cnpj(
                cnpj="11444777000161"
            )
    ...
    def test_consultar_cnpj_invalido_levanta_erro(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            ReceitaFederalApiService.consultar_cnpj(
                cnpj="12345678000199"
            )
