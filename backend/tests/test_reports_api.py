...
class TestReportTemplateEndpoints:
    ...
    def test_list_templates(self, client, auth_headers):
        ...
        with (
            patch("modules.reports.controllers.report_controller.get_db"),
            patch("modules.reports.controllers.report_controller.ReportService") as mock_service,
        ):
...
class TestBenchmarkEndpoints:
    ...
    def test_update_benchmark_company_value(self, client, auth_headers, sample_benchmark_id):
        ...
        with (
            ...
            mock_service.return_value.update_benchmark_company_value.return_value = MagicMock(
                id=sample_benchmark_id,
...
class TestValidation:
    ...
    def test_create_schedule_invalid_frequency(self, client, auth_headers, sample_template_id):
