...
from modules.recruitment.models.interview import Interview, InterviewStatus, InterviewType
...
class TestJobPositionAPI:
    ...
    async def test_create_position(self, app, sample_position_data):
        ...
        with (
            patch("modules.recruitment.controllers.job_position_controller.get_db"),
            patch("modules.recruitment.controllers.job_position_controller.get_current_user") as mock_user,
        ):
            mock_user.return_value = {"id": "user-123"}

            with patch("modules.recruitment.controllers.job_position_controller.JobPositionService") as mock_service:
    ...
    async def test_list_positions(self, app):
        ...
        with (
            ...
            with patch("modules.recruitment.controllers.job_position_controller.JobPositionService") as mock_service:
                mock_service.return_value.list_with_filters = AsyncMock(return_value=([], 0))
...
class TestCandidateAPI:
    ...
    async def test_create_candidate(self, app, sample_candidate_data):
        ...
        with (
            patch("modules.recruitment.controllers.candidate_controller.get_db"),
            patch("modules.recruitment.controllers.candidate_controller.get_current_user") as mock_user,
        ):
            mock_user.return_value = {"id": "user-123"}

            with patch("modules.recruitment.controllers.candidate_controller.CandidateService") as mock_service:
    ...
    async def test_create_duplicate_candidate(self, app, sample_candidate_data):
        ...
        with (
            ...
            with patch("modules.recruitment.controllers.candidate_controller.CandidateService") as mock_service:
                mock_service.return_value.create = AsyncMock(side_effect=ValueError("Candidato já cadastrado"))
    ...
    async def test_search_by_skills(self, app):
        ...
        with (
            ...
            with patch("modules.recruitment.controllers.candidate_controller.CandidateService") as mock_service:
                mock_service.return_value.search_by_skills = AsyncMock(return_value=[])
...
class TestApplicationAPI:
    ...
    async def test_create_application(self, app):
        ...
        with (
            patch("modules.recruitment.controllers.application_controller.get_db"),
            patch("modules.recruitment.controllers.application_controller.get_current_user") as mock_user,
        ):
            mock_user.return_value = {"id": "user-123"}

            with patch("modules.recruitment.controllers.application_controller.ApplicationService") as mock_service:
    ...
    async def test_advance_stage(self, app):
        ...
        with (
            ...
            with patch("modules.recruitment.controllers.application_controller.ApplicationService") as mock_service:
                ...
                mock_service.return_value.advance_stage = AsyncMock(return_value=application)
    ...
    async def test_bulk_action(self, app):
        ...
        with (
            ...
            with patch("modules.recruitment.controllers.application_controller.ApplicationService") as mock_service:
                mock_service.return_value.bulk_action = AsyncMock(return_value=(3, 0))
...
class TestInterviewAPI:
    ...
    async def test_create_interview(self, app):
        ...
        with (
            patch("modules.recruitment.controllers.interview_controller.get_db"),
            patch("modules.recruitment.controllers.interview_controller.get_current_user") as mock_user,
        ):
            mock_user.return_value = {"id": "user-123"}
    ...
    async def test_complete_interview(self, app):
        ...
        with (
            ...
            with patch("modules.recruitment.controllers.interview_controller.InterviewService") as mock_service:
                ...
                mock_service.return_value.complete = AsyncMock(return_value=interview)
    ...
    async def test_reschedule_interview(self, app):
        ...
        with (
            ...
            with patch("modules.recruitment.controllers.interview_controller.InterviewService") as mock_service:
                ...
                mock_service.return_value.reschedule = AsyncMock(return_value=interview)
