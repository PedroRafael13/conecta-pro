...
from modules.ged.schemas.folder import FolderResponse, FolderListResponse
from modules.ged.schemas.document import DocumentResponse, DocumentListResponse
...
class TestFolderEndpoints:
    ...
    async def test_create_folder_success(
        self, mock_current_user, sample_folder_response
    ):
        ...
        with patch(
            ...
            with patch(
                "modules.ged.controllers.folder_controller.FolderService"
            ) as mock_service:
...
class TestDocumentEndpoints:
    ...
    async def test_create_document_success(
        self, mock_current_user, sample_document_response
    ):
        ...
        with patch(
            ...
            with patch(
                "modules.ged.controllers.document_controller.DocumentService"
            ) as mock_service:
                mock_instance = AsyncMock()
    ...
    @pytest.mark.asyncio
    async def test_get_document_by_code(
        self, mock_current_user, sample_document_response
    ):
    ...
    async def test_approve_document(
        ...
        with patch(
            ...
            with patch(
                ...
                result = await mock_instance.approve(
                    sample_document_response.id,
...
class TestDocumentAIEndpoints:
    ...
    async def test_classify_document(self, mock_current_user):
        ...
        with patch(
            ...
            with patch(
                "modules.ged.controllers.document_controller.DocumentAIService"
            ) as mock_service:
                mock_instance = AsyncMock()
                ...
                result = await mock_instance.classify_document(
                    "Texto do contrato..."
                )
...
class TestDocumentShareEndpoints:
    ...
    async def test_create_public_link(self, mock_current_user):
        ...
        with patch(
            ...
            with patch(
                "modules.ged.controllers.document_share_controller.DocumentShareService"
            ) as mock_service:
                mock_instance = AsyncMock()
                ...
                result = await mock_instance.create_public_link(
                    MagicMock(document_id=str(uuid4()))
                )
...
class TestDocumentSignatureEndpoints:
    ...
    async def test_request_signatures(self, mock_current_user):
        ...
        with patch(
            ...
            with patch(
                "modules.ged.controllers.document_signature_controller.DocumentSignatureService"
            ) as mock_service:
                mock_instance = AsyncMock()
    ...
    async def test_sign_document(self, mock_current_user):
        ...
        with patch(
            ...
            with patch(
                ...
                result = await mock_instance.sign(
                    str(uuid4()),
                    MagicMock(signature_data="base64data")
                )
...
class TestDocumentTagEndpoints:
    ...
    async def test_add_tag_to_document(self, mock_current_user):
        ...
        with patch(
            ...
            with patch(
                "modules.ged.controllers.document_tag_controller.DocumentTagService"
            ) as mock_service:
                mock_instance = AsyncMock()
                mock_instance.add_to_document.return_value = True
                mock_service.return_value = mock_instance

                result = await mock_instance.add_to_document(
                    str(uuid4()),
                    str(uuid4())
                )
    ...
    async def test_get_suggested_tags(self, mock_current_user):
        ...
        with patch(
            ...
            with patch(
                ...
                result = await mock_instance.get_suggested_tags(
                    "Contrato financeiro de serviços"
                )
