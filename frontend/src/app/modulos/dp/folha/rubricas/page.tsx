      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card>
          <CardContent className="p-4">
            <div className="text-sm text-muted-foreground">Rubricas Ativas</div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-sm text-muted-foreground">Total Descontos/mes</div>
            <div className="text-2xl font-bold text-red-600">{fmt(totalDescontos)}</div>
          </CardContent>
        </Card>
      </div>
