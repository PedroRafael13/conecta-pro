  ...
  return (
    <div className="min-h-screen bg-grid">
            ...
            {actions.length === 0 && !isLoading && (
              <div className="text-center py-12 bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-xl mt-4">
                ...
                <p className="text-[hsl(var(--muted-foreground))] mt-1">
                  Ajuste os filtros ou crie uma nova medida
                </p>
      ...
      <ConfirmModal
        ...
        message={`Tem certeza que deseja excluir a medida ${selectedAction?.code}? Esta acao nao pode ser desfeita.${deleteError ? ` Erro: ${deleteError}` : ''}`}
        confirmText="Excluir"
