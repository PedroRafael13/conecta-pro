...
const TIPOS_SERVICO = [
  { id: 'kit_mensal',           label: 'Kit Mensal',        desc: 'Mão de obra presencial 24h' },
  { id: 'portaria_remota',      label: 'Portaria Remota',   desc: 'Monitoramento remoto 24h' },
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">Precificação Inteligente</h1>
          <p className="text-sm text-gray-500 mt-0.5">
            Simule preços ideais com base na CCT SINDECOMPRESTS 2026
          </p>
        </div>
