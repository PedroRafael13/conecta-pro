              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-[hsl(var(--muted-foreground))]">
                    Gestao de comunicados em campo
                  </p>
                </div>
              </div>
            </div>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-[hsl(var(--foreground))]">{stats.informativos}</p>
                  <p className="text-xs text-[hsl(var(--muted-foreground))]">Informativos</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-[hsl(var(--foreground))]">{stats.urgentes}</p>
                  <p className="text-xs text-[hsl(var(--muted-foreground))]">Urgentes</p>
                </div>
              </div>
            </CardContent>
          </Card>
