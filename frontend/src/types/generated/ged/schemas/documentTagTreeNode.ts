 ...
 */
import type { DocumentTagTreeNodeIcon } from './documentTagTreeNodeIcon';

/**
 * Schema de nó da árvore de tags.
 */
export interface DocumentTagTreeNode {
  id: string;
  name: string;
  slug: string;
  color: string;
  icon: DocumentTagTreeNodeIcon;
  usage_count: number;
  children?: DocumentTagTreeNode[];
}
