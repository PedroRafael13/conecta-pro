...
export const useSendApplicationProposal = useSendProposalApiV1RecruitmentApplicationsApplicationIdProposalPost;
export const useAcceptApplicationProposal = useAcceptProposalApiV1RecruitmentApplicationsApplicationIdAcceptProposalPost;
