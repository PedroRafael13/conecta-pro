...
export const useEnableFeatureFlag = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(error?.response?.data?.detail || 'Erro ao habilitar');
    },
  });
};
...
export const useDisableFeatureFlag = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(error?.response?.data?.detail || 'Erro ao desabilitar');
    },
  });
};
...
export const useSetFeatureFlagPercentage = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(error?.response?.data?.detail || 'Erro ao atualizar percentual');
    },
  });
};
...
export const useSetGradualRollout = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(error?.response?.data?.detail || 'Erro ao configurar rollout');
    },
  });
};
