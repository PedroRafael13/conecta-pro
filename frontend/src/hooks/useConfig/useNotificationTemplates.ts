...
export const useActivateNotificationTemplate = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(error?.response?.data?.detail || 'Erro ao ativar');
    },
  });
};
...
export const useRenderNotificationTemplate = () => {
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(error?.response?.data?.detail || 'Erro ao renderizar');
    },
  });
};
...
export const useCloneNotificationTemplate = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(error?.response?.data?.detail || 'Erro ao clonar');
    },
  });
};
