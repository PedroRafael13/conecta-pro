...
export function LoginPage() {
  ...
  const onSubmit = async (data: LoginForm) => {
    ...
    try {
      ...
      // Mock login success
      success('Login realizado com sucesso!', 'Bem-vindo ao Conecta PRO');
      navigate('/');
    } catch (err) {
      error('Erro no login', 'Email ou senha inválidos');
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="space-y-8">
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="lg:hidden flex justify-center mb-6">
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-accent-primary to-accent-secondary flex items-center justify-center shadow-glow">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
                {...register('remember')}
                className="w-4 h-4 rounded border-border-default bg-bg-tertiary text-accent-primary
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-bg-primary text-text-muted">ou continue com</span>
          </div>
        </div>
