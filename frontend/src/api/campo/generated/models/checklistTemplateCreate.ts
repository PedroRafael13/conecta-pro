 ...
 */
import type { ChecklistTemplateCreateDescricao } from './checklistTemplateCreateDescricao';
import type { TipoServico } from './tipoServico';
import type { ChecklistTemplateCreateCategoriaEquipamento } from './checklistTemplateCreateCategoriaEquipamento';
import type { ChecklistTemplateCreatePontuacaoMaxima } from './checklistTemplateCreatePontuacaoMaxima';
import type { ChecklistTemplateCreateTags } from './checklistTemplateCreateTags';
...
export interface ChecklistTemplateCreate {
   ...
   */
  nome: string;
  descricao?: ChecklistTemplateCreateDescricao;
  tipo_servico?: TipoServico;
  categoria_equipamento?: ChecklistTemplateCreateCategoriaEquipamento;
  is_obrigatorio?: boolean;
  permite_itens_adicionais?: boolean;
  tempo_estimado_minutos?: number;
  pontuacao_maxima?: ChecklistTemplateCreatePontuacaoMaxima;
  visivel_cliente?: boolean;
  tags?: ChecklistTemplateCreateTags;
}
