 ...
 */
import type { AprovarRequisicaoRequestItensAprovados } from './aprovarRequisicaoRequestItensAprovados';
import type { AprovarRequisicaoRequestObservacoes } from './aprovarRequisicaoRequestObservacoes';

/**
 * Request para aprovar requisição.
 */
export interface AprovarRequisicaoRequest {
  aprovador_id: string;
  itens_aprovados?: AprovarRequisicaoRequestItensAprovados;
  observacoes?: AprovarRequisicaoRequestObservacoes;
}
