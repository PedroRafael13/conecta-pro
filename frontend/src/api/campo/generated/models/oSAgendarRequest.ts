 ...
 */
import type { OSAgendarRequestHorarioFimPrevisto } from './oSAgendarRequestHorarioFimPrevisto';
import type { OSAgendarRequestTecnicoId } from './oSAgendarRequestTecnicoId';

/**
 * Schema para agendar OS.
 */
export interface OSAgendarRequest {
  data_agendada: string;
  horario_inicio_previsto: string;
  horario_fim_previsto?: OSAgendarRequestHorarioFimPrevisto;
  tecnico_id?: OSAgendarRequestTecnicoId;
}
