 ...
 */
import type { SSHConnectionRequestPassword } from './sSHConnectionRequestPassword';
import type { SSHConnectionRequestPrivateKey } from './sSHConnectionRequestPrivateKey';
...
export interface SSHConnectionRequest {
  ...
  port?: number;
  username: string;
  password?: SSHConnectionRequestPassword;
  private_key?: SSHConnectionRequestPrivateKey;
