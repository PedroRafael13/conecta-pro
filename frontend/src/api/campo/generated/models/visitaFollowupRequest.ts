 ...
 */
import type { VisitaFollowupRequestObservacoes } from './visitaFollowupRequestObservacoes';

/**
 * Schema para agendar follow-up.
 */
export interface VisitaFollowupRequest {
  data: string;
  /** @maxLength 50 */
  tipo: string;
  observacoes?: VisitaFollowupRequestObservacoes;
}
