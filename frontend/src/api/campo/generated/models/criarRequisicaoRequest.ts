 ...
 */
import type { ItemRequisicaoRequest } from './itemRequisicaoRequest';
import type { CriarRequisicaoRequestObservacoes } from './criarRequisicaoRequestObservacoes';

/**
 * Request para criar requisição.
 */
export interface CriarRequisicaoRequest {
  ordem_servico_id: string;
  tecnico_id: string;
  itens: ItemRequisicaoRequest[];
  observacoes?: CriarRequisicaoRequestObservacoes;
}
