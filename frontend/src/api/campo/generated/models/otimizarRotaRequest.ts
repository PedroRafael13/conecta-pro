 ...
 */
import type { TipoOtimizacao } from './tipoOtimizacao';
import type { OtimizarRotaRequestPontoPartida } from './otimizarRotaRequestPontoPartida';
import type { OtimizarRotaRequestPontoRetorno } from './otimizarRotaRequestPontoRetorno';

/**
 * Request para otimizar rota.
 */
export interface OtimizarRotaRequest {
  tecnico_id: string;
  data: string;
  tipo_otimizacao?: TipoOtimizacao;
  ponto_partida?: OtimizarRotaRequestPontoPartida;
  ponto_retorno?: OtimizarRotaRequestPontoRetorno;
}
