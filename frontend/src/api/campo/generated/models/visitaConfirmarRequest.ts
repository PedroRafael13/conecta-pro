 ...
 */
import type { VisitaConfirmarRequestConfirmadoPor } from './visitaConfirmarRequestConfirmadoPor';

/**
 * Schema para confirmar visita.
 */
export interface VisitaConfirmarRequest {
  confirmado_por?: VisitaConfirmarRequestConfirmadoPor;
}
