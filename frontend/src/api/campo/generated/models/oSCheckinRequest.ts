 ...
 */
import type { OSCheckinRequestLatitude } from './oSCheckinRequestLatitude';
import type { OSCheckinRequestLongitude } from './oSCheckinRequestLongitude';

/**
 * Schema para check-in.
 */
export interface OSCheckinRequest {
  latitude?: OSCheckinRequestLatitude;
  longitude?: OSCheckinRequestLongitude;
}
