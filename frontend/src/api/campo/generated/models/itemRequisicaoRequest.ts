 ...
 */
import type { ItemRequisicaoRequestQuantidade } from './itemRequisicaoRequestQuantidade';
import type { ItemRequisicaoRequestObservacao } from './itemRequisicaoRequestObservacao';

/**
 * Item para requisição.
 */
export interface ItemRequisicaoRequest {
  produto_id: string;
  quantidade: ItemRequisicaoRequestQuantidade;
  observacao?: ItemRequisicaoRequestObservacao;
}
