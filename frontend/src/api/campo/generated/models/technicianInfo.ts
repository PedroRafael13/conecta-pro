 ...
 */
import type { TechnicianInfoId } from './technicianInfoId';
import type { TechnicianInfoCurrentLocation } from './technicianInfoCurrentLocation';
...
export interface TechnicianInfo {
  ...
  specialty: string;
  status?: string;
  current_location?: TechnicianInfoCurrentLocation;
}
