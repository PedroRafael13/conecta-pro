 ...
 */
import type { ChecklistResponderRequestValorAnyOf } from './checklistResponderRequestValorAnyOf';

export type ChecklistResponderRequestValor = string | number | number | boolean | unknown[] | ChecklistResponderRequestValorAnyOf | null;
