 ...
 */
import type { AnaliseEquipeResponseRotasItem } from './analiseEquipeResponseRotasItem';
import type { AnaliseEquipeResponseTotais } from './analiseEquipeResponseTotais';

/**
 * Response de análise da equipe.
 */
export interface AnaliseEquipeResponse {
  data: string;
  tecnicos_analisados: number;
  rotas: AnaliseEquipeResponseRotasItem[];
  totais: AnaliseEquipeResponseTotais;
}
