 ...
 */
import type { ChecklistPreenchidoRead } from './checklistPreenchidoRead';
import type { ChecklistTemplateRead } from './checklistTemplateRead';
import type { ChecklistItemRead } from './checklistItemRead';
import type { ChecklistRespostaRead } from './checklistRespostaRead';

/**
 * Checklist preenchido com template, itens e respostas.
 */
export interface ChecklistPreenchidoCompleto {
  preenchimento: ChecklistPreenchidoRead;
  template: ChecklistTemplateRead;
  itens: ChecklistItemRead[];
  respostas: ChecklistRespostaRead[];
}
