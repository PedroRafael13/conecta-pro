 ...
 */
import type { GuardianOccurrenceResolveFollowupNotes } from './guardianOccurrenceResolveFollowupNotes';

/**
 * Schema para resolver ocorrência.
 */
export interface GuardianOccurrenceResolve {
  /**
  ...
  /** Notas de follow-up */
  followup_notes?: GuardianOccurrenceResolveFollowupNotes;
}
