 ...
 */
import type { OSFotoRequestDescricao } from './oSFotoRequestDescricao';

/**
 * Schema para adicionar foto.
 */
export interface OSFotoRequest {
  /** @pattern ^(antes|durante|depois)$ */
  tipo: string;
  url: string;
  descricao?: OSFotoRequestDescricao;
}
