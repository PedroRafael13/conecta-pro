 ...
 */
import type { ItemBaixaRequestQuantidadeUtilizada } from './itemBaixaRequestQuantidadeUtilizada';
import type { ItemBaixaRequestQuantidadeRequisitada } from './itemBaixaRequestQuantidadeRequisitada';

/**
 * Item para baixa.
 */
export interface ItemBaixaRequest {
  produto_id: string;
  quantidade_utilizada: ItemBaixaRequestQuantidadeUtilizada;
  quantidade_requisitada?: ItemBaixaRequestQuantidadeRequisitada;
}
