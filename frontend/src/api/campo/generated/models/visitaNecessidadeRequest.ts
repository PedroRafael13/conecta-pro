 ...
 */
import type { VisitaNecessidadeRequestEstimativaValor } from './visitaNecessidadeRequestEstimativaValor';

/**
 * Schema para adicionar necessidade.
 */
export interface VisitaNecessidadeRequest {
  categoria: string;
  descricao: string;
  /**
   * @minimum 1
   ...
   */
  prioridade?: number;
  estimativa_valor?: VisitaNecessidadeRequestEstimativaValor;
}
