 ...
 */
import type { VisitaInteresseRequestServicos } from './visitaInteresseRequestServicos';

/**
 * Schema para registrar interesse.
 */
export interface VisitaInteresseRequest {
  /**
   * @minimum 1
   * @maximum 5
   */
  nivel: number;
  servicos?: VisitaInteresseRequestServicos;
}
