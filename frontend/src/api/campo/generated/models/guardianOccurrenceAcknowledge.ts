 ...
 */
import type { GuardianOccurrenceAcknowledgeNotes } from './guardianOccurrenceAcknowledgeNotes';

/**
 * Schema para reconhecer ocorrência.
 */
export interface GuardianOccurrenceAcknowledge {
  /** Observações */
  notes?: GuardianOccurrenceAcknowledgeNotes;
}
