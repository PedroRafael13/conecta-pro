 ...
 */
import type { ItemBaixaRequest } from './itemBaixaRequest';
import type { RegistrarBaixaRequestTecnicoId } from './registrarBaixaRequestTecnicoId';

/**
 * Request para registrar baixa.
 */
export interface RegistrarBaixaRequest {
  itens_utilizados: ItemBaixaRequest[];
  tecnico_id?: RegistrarBaixaRequestTecnicoId;
}
