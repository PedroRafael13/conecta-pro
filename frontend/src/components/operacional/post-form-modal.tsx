      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="flex gap-6">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-sm text-[hsl(var(--foreground))]">Requer Armamento</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
                ...
                className="w-4 h-4 rounded border-[hsl(var(--border))]"
              />
              <span className="text-sm text-[hsl(var(--foreground))]">Requer Veiculo</span>
            </label>
          </div>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={3}
            placeholder="Observacoes adicionais sobre o posto..."
            className="w-full px-3 py-2 rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--background))] text-[hsl(var(--foreground))] resize-none"
          />
        </div>
