/**
 * Testes E2E - Detalhe de Proposta por ID
 * Página: /modulos/licitacoes/propostas/[id]
 *
 * Testa visualização completa de proposta, gerenciamento de itens,
 * submissão, alteração de status e histórico da proposta.
 */

import { test, expect } from '@playwright/test';
import { loginViaAPI } from '../helpers/auth';

// Mock de dados da proposta
const mockProposta = {
    ...
    if (method === 'GET' && !url.includes('/items')) {
      if (id === '660e8400-e29b-41d4-a716-446655440002') {
        ...
        route.fulfill({
          status: 404,
          contentType: 'application/json',
          body: JSON.stringify({ error: 'Proposta não encontrada' }),
        });
      } else {
        route.fulfill({
          status: 200,
          contentType: 'application/json',
          body: JSON.stringify({ data: mockProposta }),
        });
      }
...
test.describe('Propostas ID - Visualização Geral', () => {
  ...
  test('deve exibir número da proposta no header', async ({ page }) => {
    await page.goto('/modulos/licitacoes/propostas/660e8400-e29b-41d4-a716-446655440001');
    await page.waitForTimeout(2000);

    const numero = page.locator('text=/PROP-2024-001/i').first();
...
test.describe('Propostas ID - Cards de Resumo', () => {
  test('deve exibir card de valor global', async ({ page }) => {
    await page.goto('/modulos/licitacoes/propostas/660e8400-e29b-41d4-a716-446655440001');
    await page.waitForTimeout(2000);

    const valor = page.locator('text=/Valor Global/i').first();
  ...
  test('deve exibir card de status', async ({ page }) => {
    await page.goto('/modulos/licitacoes/propostas/660e8400-e29b-41d4-a716-446655440001');
    await page.waitForTimeout(2000);

    const status = page.locator('text=/Status/i').first();
    await expect(status).toBeVisible();
  });

  test('deve exibir badge de status da proposta', async ({ page }) => {
    await page.goto('/modulos/licitacoes/propostas/660e8400-e29b-41d4-a716-446655440001');
    await page.waitForTimeout(2000);
...
test.describe('Propostas ID - Botão Voltar', () => {
...
test.describe('Propostas ID - Abas de Navegação', () => {
  ...
  test('deve exibir contagem de itens na aba', async ({ page }) => {
    await page.goto('/modulos/licitacoes/propostas/660e8400-e29b-41d4-a716-446655440001');
    await page.waitForTimeout(2000);
...
test.describe('Propostas ID - Aba Dados Gerais', () => {
  test('deve exibir informações do edital vinculado', async ({ page }) => {
    await page.goto('/modulos/licitacoes/propostas/660e8400-e29b-41d4-a716-446655440001');
    await page.waitForTimeout(2000);

    const edital = page.locator('text=/ID do Edital|Edital/i').first();
    const hasEdital = await edital.isVisible().catch(() => false);
  ...
  test('deve exibir seletor de status', async ({ page }) => {
    await page.goto('/modulos/licitacoes/propostas/660e8400-e29b-41d4-a716-446655440001');
    await page.waitForTimeout(2000);
...
test.describe('Propostas ID - Observações', () => {
...
test.describe('Propostas ID - Ações por Status', () => {
  test('deve exibir botão submeter para proposta em rascunho', async ({ page }) => {
    await page.goto('/modulos/licitacoes/propostas/660e8400-e29b-41d4-a716-446655440001');
    await page.waitForTimeout(2000);
  ...
  test('deve exibir botão editar para proposta em rascunho', async ({ page }) => {
    await page.goto('/modulos/licitacoes/propostas/660e8400-e29b-41d4-a716-446655440001');
    await page.waitForTimeout(2000);
...
test.describe('Propostas ID - Modal de Submissão', () => {
...
test.describe('Propostas ID - Modal de Edição', () => {
...
test.describe('Propostas ID - Estados Diferentes', () => {
  test('deve exibir proposta em status rascunho', async ({ page }) => {
    await page.goto('/modulos/licitacoes/propostas/660e8400-e29b-41d4-a716-446655440001');
    await page.waitForTimeout(2000);
...
test.describe('Propostas ID - Aba Histórico', () => {
  test('deve exibir histórico de status', async ({ page }) => {
    await page.goto('/modulos/licitacoes/propostas/660e8400-e29b-41d4-a716-446655440001');
    await page.waitForTimeout(2000);

    // Clicar na aba de histórico
    const abaHistorico = page.locator('button:has-text("Histórico")').first();
    if (await abaHistorico.isVisible().catch(() => false)) {
      await abaHistorico.click();
      await page.waitForTimeout(500);

      const historico = page.locator('text=/Histórico de Status|Proposta Criada/i').first();
      const hasHistorico = await historico.isVisible().catch(() => false);
      expect(hasHistorico !== undefined).toBeTruthy();
    }
  });
});

test.describe('Propostas ID - Erro de Carregamento', () => {
  test('deve exibir mensagem de erro quando proposta não existe', async ({ page }) => {
    await page.goto('/modulos/licitacoes/propostas/not-found');
    await page.waitForTimeout(2000);
