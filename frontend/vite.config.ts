...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['favicon.ico', 'logo-conecta-pro.svg', 'robots.txt'],
      manifest: {
        name: 'Conecta PRO',
        short_name: 'Conecta PRO',
        description: 'Sistema de Gestao Empresarial Inteligente',
        theme_color: '#0A2540',
