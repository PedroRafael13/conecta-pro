...
if __name__ == "__main__":
    ...
    # Testes válidos
    assert validator.validate_table_name("clientes") == True
    assert validator.validate_table_name("CLIENTES") == True  # Case insensitive
    assert validator.validate_table_name("  clientes  ") == True  # Strip whitespace
    ...
    assert validate_table_name("documents") == True
